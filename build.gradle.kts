  ...
  pluginConfiguration {
    ...
    changeNotes.set(
      """
        ...
        * <a href="https://youtrack.jetbrains.com/issue/VIM-4207">VIM-4207</a> Added <code>:update</code> command - like <code>:write</code> but only saves if the buffer has been modified; short form <code>:up</code> also supported<br>
        <br>
        <b>Fixes:</b><br>
