...
intellijPlatform {
  pluginConfiguration {
    ...
    changeNotes.set(
      """
        <b>Features:</b><br>
        * <a href="https://youtrack.jetbrains.com/issue/VIM-266">VIM-266</a> The <code>:edit</code> command now creates the file if it doesn't exist, matching Vim behavior<br>
        <br>
        <b>Fixes:</b><br>
