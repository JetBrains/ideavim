...
* [VIM-4207](https://youtrack.jetbrains.com/issue/VIM-4207) Added `:update` command - like `:write` but only saves if the buffer has been modified; short form `:up` also supported
