...
### Fixes:
* [VIM-2431](https://youtrack.jetbrains.com/issue/VIM-2431) Fixed `<Action>` mappings to accept count prefix (e.g., `5gj` with `map gj <Action>(EditorCloneCaretBelow)` now executes 5 times)
