...
* [VIM-566](https://youtrack.jetbrains.com/issue/VIM-566) Added operator-pending mode support for `zj` and `zk` - use `dzj` to delete to next fold, `yzk` to yank to previous fold
