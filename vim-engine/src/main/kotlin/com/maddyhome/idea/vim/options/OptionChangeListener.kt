 ...
 * or [OptionScope.EFFECTIVE] scope changes. For local-to-window options, the editor specified by [OptionScope.LOCAL] or
 * [OptionScope.EFFECTIVE] will be notified. There will be no notifications to changes to the global scope of local
