...
sealed class MappingOwner {
  interface IdeaVim {
    ...
    /**
     * Language (`:lmap`) mappings generated by `:loadkeymap` for the `'keymap'` option. Kept separate from
     * [InitScript] so that changing or clearing `'keymap'` only unloads the keymap's own mappings, not the user's
     * other mappings from the .ideavimrc.
     */
    object Keymap : MappingOwner()
  }
