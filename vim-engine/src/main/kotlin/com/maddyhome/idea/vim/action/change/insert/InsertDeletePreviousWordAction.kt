...
class InsertDeletePreviousWordAction : ChangeEditorActionHandler.ForEachCaret() {
  ...
  override fun execute(
    ...
    return insertDeletePreviousWord(editor, context, caret, operatorArguments)
  }
}
 ...
 */
private fun insertDeletePreviousWord(editor: VimEditor, context: ExecutionContext, caret: VimCaret, operatorArguments: OperatorArguments): Boolean {
  ...
  injector.changeGroup.deleteRange(editor, context, caret, range, SelectionType.CHARACTER_WISE, true, operatorArguments)
  return true
}
