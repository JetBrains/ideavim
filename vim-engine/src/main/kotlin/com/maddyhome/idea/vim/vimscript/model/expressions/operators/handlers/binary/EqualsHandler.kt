...
internal object EqualsHandler : BinaryOperatorWithIgnoreCaseOption(EqualsIgnoreCaseHandler, EqualsCaseSensitiveHandler)

internal object EqualsIgnoreCaseHandler : ComparisonOperatorHandler() {
...
internal object EqualsCaseSensitiveHandler : ComparisonOperatorHandler() {
  override fun compare(left: Double, right: Double) = left == right
  override fun compare(left: Int, right: Int) = left == right
