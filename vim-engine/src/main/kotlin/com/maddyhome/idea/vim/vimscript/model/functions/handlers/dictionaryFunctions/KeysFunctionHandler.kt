...
@VimscriptFunction(name = "keys")
internal class KeysFunctionHandler : UnaryFunctionHandler<VimList>() {
  override fun doFunction(
    ...
    val dict = arguments[0]
    if (dict !is VimDictionary) {
      throw exExceptionMessage("E1206", 1)
    }
    return VimList(dict.dictionary.keys.toMutableList())
  }
}
