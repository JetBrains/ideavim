...
kotlin {
  ...
  compilerOptions {
    ...
    // which on newer platforms (2026.1 / EAP) is built for JVM target 25. A lower target here
    // fails with "Cannot inline bytecode built with JVM target 25 into bytecode ... target 21".
