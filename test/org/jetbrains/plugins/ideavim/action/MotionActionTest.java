...
public class MotionActionTest extends VimTestCase {
  ...
  public void testEscapeInCommand() {
    typeTextInFile(parseKeys("f", "<Esc>", "<Esc>"), "on<caret>e two\n" + "three\n");
  ...
  public void testLeftRightMove() {
    typeTextInFile(parseKeys("14l", "2h"), "on<caret>e two three four five six seven\n");
    assertOffset(14);
  }
  ...
  public void testForwardToTab() {
    typeTextInFile(parseKeys("f<Tab>"), "on<caret>e two\tthree\nfour\n");
    assertOffset(7);
    assertMode(COMMAND);
  }
  ...
  public void testBackToDigraph() {
    typeTextInFile(parseKeys("F<C-K>O:"), "Hallo, Öster<caret>reich!\n");
  ...
  public void testTillCharRight() {
    typeTextInFile(parseKeys("t:;"), "<caret> 1:a 2:b 3:c \n");
  ...
  public void testTillCharRightRepeatedWithCount2() {
    typeTextInFile(parseKeys("t:2;"), "<caret> 1:a 2:b 3:c \n");
    myFixture.checkResult(" 1:a <caret>2:b 3:c \n");
  }
  ...
  public void testDeleteInnerCurlyBraceBlock() {
    typeTextInFile(parseKeys("di{"), "{foo, b<caret>ar, baz}\n");
    myFixture.checkResult("{}\n");
  }

  // VIM-314 |d| |v_iB|
  public void testDeleteInnerCurlyBraceBlockCaretBeforeString() {
    typeTextInFile(parseKeys("di{"), "{foo, <caret>\"bar\", baz}\n");
    myFixture.checkResult("{}\n");
  }

  // |d| |v_aB|
  public void testDeleteOuterCurlyBraceBlock() {
    typeTextInFile(parseKeys("da{"), "x = {foo, b<caret>ar, baz};\n");
    myFixture.checkResult("x = ;\n");
  }
  ...
  public void testDeleteInnerParensBlockBeforeClose() {
    typeTextInFile(parseKeys("di)"), "foo(bar<caret>)\n");
    myFixture.checkResult("foo()\n");
  }

  // |d| |v_ab|
  public void testDeleteOuterBlock() {
    typeTextInFile(parseKeys("da)"), "foo(b<caret>ar, baz);\n");
    myFixture.checkResult("foo;\n");
  }
  ...
  public void testDeleteOuterWord() {
    typeTextInFile(parseKeys("daw"), "one t<caret>wo three\n");
  ...
  public void testDeleteInnerSentence() {
    typeTextInFile(parseKeys("dis"), "Hello World! How a<caret>re you? Bye.\n");
    myFixture.checkResult("Hello World!  Bye.\n");
  }

  // |d| |v_as|
  public void testDeleteOuterSentence() {
    typeTextInFile(parseKeys("das"), "Hello World! How a<caret>re you? Bye.\n");
    myFixture.checkResult("Hello World! Bye.\n");
  }
  ...
  public void testDeleteInnerParagraph() {
    typeTextInFile(parseKeys("dip"), "Hello World!\n" +
                                     "\n" +
                                     "How a<caret>re you?\n" +
                                     "Bye.\n" +
                                     "\n" +
  ...
  public void testDeleteOuterParagraph() {
    typeTextInFile(parseKeys("dap"), "Hello World!\n" +
                                     "\n" +
                                     "How a<caret>re you?\n" +
                                     "Bye.\n" +
                                     "\n" +
  ...
  public void testDeleteOuterBracketBlock() {
    typeTextInFile(parseKeys("da]"), "foo = [\n" +
                                     "    one,\n" +
                                     "    t<caret>wo,\n" +
                                     "    three\n" +
                                     "];\n");
  ...
  public void testPercentMatchSimple() {
    typeTextInFile(parseKeys("%"), "foo(b<caret>ar)\n");
    assertOffset(3);
  }

  // |%|
  public void testPercentMatchMultiLine() {
    typeTextInFile(parseKeys("%"), "foo(bar,\n" +
                                   "    baz,\n" +
                                   "    <caret>quux)\n");
    assertOffset(3);
  }
  ...
  public void testPercentMatchParensInString() {
    typeTextInFile(parseKeys("%"), "foo(bar, \"foo(bar\", <caret>baz)\n");
    assertOffset(3);
  }
  ...
  public void testUnmatchedCloseParenthesisMultiLine() {
    typeTextInFile(parseKeys("])"), "foo(bar, <caret>baz,\n" + "   quux)\n");
    assertOffset(21);
  }

  // |]}|
  public void testUnmatchedCloseBracket() {
    typeTextInFile(parseKeys("]}"), "{bar, <caret>baz}\n");
    assertOffset(9);
  }
  ...
  public void testWordBackwardsAtFirstLineWithWhitespaceInFront() {
    typeTextInFile(parseKeys("b"), "    <caret>x\n");
    assertOffset(0);
  }
  ...
  public void testDownToLastEmptyLine() {
    typeTextInFile(parseKeys("j"), "<caret>one\n" + "\n");
    assertOffset(4);
  }
  ...
  public void testSwapVisualSelections() {
    typeTextInFile(parseKeys("viw", "<Esc>", "0", "viw", "gv", "d"), "foo <caret>bar\n");
    myFixture.checkResult("foo \n");
  }

  // |CTRL-V|
  public void testVisualBlockSelectionsDisplayedCorrectlyMovingRight() {
    typeTextInFile(parseKeys("<C-V>jl"), "<caret>foo\n" + "bar\n");
  ...
  public void testVisualBlockSelectionsDisplayedCorrectlyMovingLeft() {
    typeTextInFile(parseKeys("<C-V>jh"), "fo<caret>o\n" + "bar\n");
  ...
  public void testVisualBlockSelectionsDisplayedCorrectlyInDollarMode() {
    typeTextInFile(parseKeys("<C-V>jj$"), "a<caret>b\n" +
                                          "abc\n" +
                                          "ab\n");
  ...
  public void testSwapVisualSelectionEnds() {
    typeTextInFile(parseKeys("v", "l", "o", "l", "d"), "<caret>foo\n");
    myFixture.checkResult("fo\n");
  }

  // VIM-646 |gv|
  public void testRestoreMultiLineSelectionAfterYank() {
    typeTextInFile(parseKeys("V", "j", "y", "G", "p", "gv", "d"), "<caret>foo\n" +
                                                                  "bar\n" +
                                                                  "baz\n");
  ...
  public void testRestoreMultiLineSelectionAfterIndent() {
    typeTextInFile(parseKeys("V", "2j"), "<caret>foo\n" +
                                         "bar\n" +
                                         "baz\n");
    assertSelection("foo\n" +
                    "bar\n" +
  ...
  public void testVisualLineSelectDown() {
    typeTextInFile(parseKeys("Vj"), "foo\n" +
                                    "<caret>bar\n" +
                                    "baz\n" +
                                    "quux\n");
    assertMode(VISUAL);
  ...
  public void testVisualLineSelectUp() {
    typeTextInFile(parseKeys("Vk"), "foo\n" +
                                    "bar\n" +
                                    "<caret>baz\n" +
                                    "quux\n");
    assertMode(VISUAL);
