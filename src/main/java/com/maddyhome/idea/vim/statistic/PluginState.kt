  ...
  override fun getMetrics(): Set<MetricEvent> {
    return setOf(
      PLUGIN_STATE.metric(
        ...
        ENABLED_EXTENSIONS with ExtensionTracking.enabledExtensions.toList(),
      ),
    )
  }
}
...
private val ENABLED_EXTENSIONS = EventFields.StringList("enabled_extensions", ExtensionTracking.extensionNames)
