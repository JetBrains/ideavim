    ...
    super(new VisualOperatorActionHandler() {
      ...
      protected boolean executeCharacterAndLinewise(@NotNull Editor editor,
        ...
        return argument != null &&
               VimPlugin.getChange()
                 .changeCharacterRange(editor, UtilsKt.getVimTextRange(range), argument.getCharacter());
      }
      ...
      protected boolean executeBlockwise(@NotNull Editor editor,
        ...
        return argument != null &&
               VimPlugin.getChange()
                 .changeCharacterRange(editor, UtilsKt.getVimTextRange(ranges), argument.getCharacter());
      }
    });
  }
