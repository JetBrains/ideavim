...
public class ChangeVisualNumberAvalancheIncAction extends VimCommandAction {
    protected ChangeVisualNumberAvalancheIncAction() {
        super(new VisualOperatorActionHandler(true, CaretOrder.DECREASING_OFFSET) {
            ...
            protected boolean execute(@NotNull Editor editor, @NotNull Caret caret, @NotNull DataContext context,
                ...
                return VimPlugin.getChange().changeNumberVisualMode(editor, caret, range, cmd.getCount(), true);
            }
        });
    }
