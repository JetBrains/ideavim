...
private object SelectMoveUpActionHandler : MotionActionHandler.ForEachCaret() {
...
class SelectMotionUpAction : VimCommandAction(SelectMoveUpActionHandler) {
    override fun getMappingModes(): MutableSet<MappingMode> = MappingMode.S

    override fun getKeyStrokesSet(): MutableSet<MutableList<KeyStroke>> = parseKeysSet("<UP>")
