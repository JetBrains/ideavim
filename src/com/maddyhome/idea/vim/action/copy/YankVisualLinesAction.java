      ...
      public boolean executeBatch(@NotNull Editor editor,
        ...
        if (mode == CommandState.SubMode.VISUAL_BLOCK) {
          return YankCopyGroup.INSTANCE
            .yankRange(editor, UtilsKt.getVimTextRange(ranges), SelectionType.fromSubMode(mode), true);
        }
        else {
          return YankCopyGroup.INSTANCE
            .yankRange(editor, UtilsKt.getVimTextRange(ranges), SelectionType.LINE_WISE, true);
        }
      }
    });
  }
