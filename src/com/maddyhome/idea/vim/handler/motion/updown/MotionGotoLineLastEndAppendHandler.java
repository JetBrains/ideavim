...
/**
 */
public class MotionGotoLineLastEndAppendHandler extends MotionEditorActionHandler
{
    public int getOffset(Editor editor, DataContext context, int count, int rawCount, Argument argument)
    {
        return CommandGroups.getInstance().getMotion().moveCaretGotoLineLastEndAppend(editor, context, rawCount, count - 1);
    }
}
