...
public class Options {
  ...
  private void createDefaultOptions() {
    ...
    addOption(new BoundListOption(KEYMODEL, "km", new String[]{"acontinueselect", "stopselect"}, new String[]{"startsel", "stopsel", "stopselect", "stopvisual", "acontinueselect", "acontinuevisual"}));
