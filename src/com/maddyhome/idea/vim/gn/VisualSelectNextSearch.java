 ...
 * Copyright (C) 2003-2017 The IdeaVim authors
 *
 ...
 */
package com.maddyhome.idea.vim.gn;
...
public class VisualSelectNextSearch extends VimCommandAction {
  public VisualSelectNextSearch() {
    super(new Handler());
  }
