...
public class RegisterActions {
  ...
  private static void registerVariousModesActions() {
    ...
    parser.registerAction(MappingMode.VO, "VimMotionTextOuterWord", Command.Type.MOTION,
                          EnumSet.of(CommandFlags.FLAG_MOT_CHARACTERWISE, CommandFlags.FLAG_MOT_INCLUSIVE), new Shortcut("aw"));
    ...
    parser.registerAction(MappingMode.VO, "VimMotionTextInnerWord", Command.Type.MOTION,
                          EnumSet.of(CommandFlags.FLAG_MOT_CHARACTERWISE, CommandFlags.FLAG_MOT_INCLUSIVE), new Shortcut("iw"));
    ...
    parser.registerAction(MappingMode.VO, "VimMotionOuterParagraph", Command.Type.MOTION,
                          EnumSet.of(CommandFlags.FLAG_MOT_LINEWISE, CommandFlags.FLAG_TEXT_BLOCK), new Shortcut("ap"));
    parser.registerAction(MappingMode.VO, "VimMotionInnerSentence",
                          Command.Type.MOTION,
                          EnumSet.of(CommandFlags.FLAG_MOT_INCLUSIVE, CommandFlags.FLAG_TEXT_BLOCK),
                          new Shortcut("is"));
    parser.registerAction(MappingMode.VO, "VimMotionOuterSentence", Command.Type.MOTION,
                          EnumSet.of(CommandFlags.FLAG_MOT_INCLUSIVE, CommandFlags.FLAG_TEXT_BLOCK), new Shortcut("as"));
    ...
    parser.registerAction(MappingMode.VO, "VimMotionOuterBlockAngle",
                          Command.Type.MOTION,
                          EnumSet.of(CommandFlags.FLAG_MOT_CHARACTERWISE, CommandFlags.FLAG_MOT_INCLUSIVE, CommandFlags.FLAG_TEXT_BLOCK), new Shortcut[]{
        new Shortcut("a<"),
        new Shortcut("a>")
      });
