...
class OptionScopeTest : VimTestCase() {
  ...
  fun `test option function returns value`() {
    val history = runBlocking { myVimApi.option { get<Int>("history") } }
    assertEquals(50, history) // Default value

    runBlocking { myVimApi.option { set<Int>("history", 100) } }

    val newHistory = runBlocking { myVimApi.option { get<Int>("history") } }
