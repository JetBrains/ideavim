...
//  }
  ...
  fun `test scroll down with scrolljump and scrolloff 2`() {
    VimPlugin.getOptionService().setOptionValue(OptionScope.GLOBAL, OptionConstants.scrolljump, VimInt(15))
    VimPlugin.getOptionService().setOptionValue(OptionScope.GLOBAL, OptionConstants.scrolloff, VimInt(5))
    configureByPages(5)
    setPositionAndScroll(0, 24)
  ...
  fun `test scroll down with scrolljump and scrolloff 3`() {
    VimPlugin.getOptionService().setOptionValue(OptionScope.GLOBAL, OptionConstants.scrolljump, VimInt(20))
    VimPlugin.getOptionService().setOptionValue(OptionScope.GLOBAL, OptionConstants.scrolloff, VimInt(5))
    configureByPages(5)
    setPositionAndScroll(0, 24)
  ...
  fun `test scroll down with scrolljump and scrolloff 4`() {
    VimPlugin.getOptionService().setOptionValue(OptionScope.GLOBAL, OptionConstants.scrolljump, VimInt(11))
    VimPlugin.getOptionService().setOptionValue(OptionScope.GLOBAL, OptionConstants.scrolloff, VimInt(5))
    configureByPages(5)
    setPositionAndScroll(0, 24)
