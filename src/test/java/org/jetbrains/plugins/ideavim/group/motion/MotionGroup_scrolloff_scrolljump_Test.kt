...
class MotionGroup_scrolloff_Test : VimOptionTestCase(ScrollOffData.name) {
  ...
  @VimOptionTestConfiguration(VimTestOption(ScrollOffData.name, OptionValueType.NUMBER, "0"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollOffData.name, OptionValueType.NUMBER, "1"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollOffData.name, OptionValueType.NUMBER, "10"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollOffData.name, OptionValueType.NUMBER, "15"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollOffData.name, OptionValueType.NUMBER, "16"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollOffData.name, OptionValueType.NUMBER, "17"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollOffData.name, OptionValueType.NUMBER, "22"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollOffData.name, OptionValueType.NUMBER, "999"))
...
class MotionGroup_scrolljump_Test : VimOptionTestCase(ScrollJumpData.name) {
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollJumpData.name, OptionValueType.NUMBER, "0"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollJumpData.name, OptionValueType.NUMBER, "1"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollJumpData.name, OptionValueType.NUMBER, "10"))
  ...
  @TestWithoutNeovim(SkipNeovimReason.OPTION)
  @VimOptionTestConfiguration(VimTestOption(ScrollJumpData.name, OptionValueType.NUMBER, "-50"))
...
class MotionGroup_scrolloff_scrolljump_Test : VimOptionTestCase(ScrollJumpData.name, ScrollOffData.name) {
  ...
  @VimOptionTestConfiguration(
    VimTestOption(ScrollJumpData.name, OptionValueType.NUMBER, "10"),
    VimTestOption(ScrollOffData.name, OptionValueType.NUMBER, "5")
  )
