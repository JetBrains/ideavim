...
class SearchGroupTest : VimTestCase() {
  ...
  @TestWithoutNeovim(SkipNeovimReason.DIFFERENT, "IdeaVim wraps search motion offset at end of file")
  @Test
  ...
  @TestWithoutNeovim(SkipNeovimReason.DIFFERENT, "IdeaVim wraps reverse search motion offset at beginning of file")
  @Test
