...
class IsCaseSensitiveOperatorTest : VimTestCase("\n") {
  @Test
  fun `test is case sensitive operator with Number values`() {
    assertCommandOutput("echo 1 is# 1", "1")
  }

  @Test
  fun `test is case sensitive operator with Float values`() {
    assertCommandOutput("echo 1.0 is# 1.0", "1")
    assertCommandOutput("echo 1.0 is# 2.0", "0")
  }

  @Test
  fun `test is case sensitive operator does not coerce Number and Float`() {
    assertCommandOutput("echo 1 is# 1.0", "0")
  }

  @Test
  fun `test is case sensitive operator with String`() {
  ...
  @Test
  fun `test is case sensitive operator does not coerce String and Number`() {
    assertCommandOutput("echo '1' is# 1", "0")
  }

  @Test
  fun `test is case sensitive operator compares List references`() {
  ...
  @Test
  fun `test is case sensitive operator compares Dictionary references`() {
    assertCommandOutput("echo {} is# {}", "0")
  ...
  @Test
  fun `test is case sensitive operator treats different Funcref function references without arguments or dictionary as same`() {
  ...
  @Test
  fun `test is case sensitive operator treats different Funcref funcref references as different`() {
  ...
  @Test
  fun `test is case sensitive operator treats Funcref references with different arguments as different`() {
  ...
  @Test
  fun `test is case sensitive operator treats Funcref references with different dictionary as different`() {
