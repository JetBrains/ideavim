...
class IsCaseInsensitiveOperatorTest : VimTestCase("\n") {
  @Test
  fun `test is case insensitive operator with Number values`() {
    assertCommandOutput("echo 1 is? 1", "1")
  }

  @Test
  fun `test is case insensitive operator with Float values`() {
    assertCommandOutput("echo 1.0 is? 1.0", "1")
    assertCommandOutput("echo 1.0 is? 2.0", "0")
  }

  @Test
  fun `test is case insensitive operator does not coerce Number and Float`() {
    assertCommandOutput("echo 1 is? 1.0", "0")
  }

  @Test
  fun `test is case insensitive operator with String`() {
  ...
  @Test
  fun `test is case insensitive operator does not coerce String and Number`() {
    assertCommandOutput("echo '1' is? 1", "0")
  }

  @Test
  fun `test is case insensitive operator compares List references`() {
    assertCommandOutput("echo [] is? []", "0")
    assertCommandOutput("echo [1, 'abc', 3] is? [1, 'abc', 3]", "0")
    assertCommandOutput("echo [1, 'abc', 3] is? [1, 'ABC', 3]", "0")
  ...
  @Test
  fun `test is case insensitive operator compares Dictionary references`() {
    assertCommandOutput("echo {} is? {}", "0")
  ...
  @Test
  fun `test is case insensitive operator treats different Funcref function references without arguments or dictionary as same`() {
  ...
  @Test
  fun `test is case insensitive operator treats different Funcref funcref references as different`() {
  ...
  @Test
  fun `test is case insensitive operator treats Funcref references with different arguments as different`() {
  ...
  @Test
  fun `test is case insensitive operator treats Funcref references with different dictionary as different`() {
