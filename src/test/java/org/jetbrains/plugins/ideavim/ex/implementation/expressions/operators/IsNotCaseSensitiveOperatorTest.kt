...
class IsNotCaseSensitiveOperatorTest : VimTestCase("\n") {
  @Test
  fun `test isnot case sensitive operator with Number values`() {
    assertCommandOutput("echo 1 isnot# 1", "0")
  }

  @Test
  fun `test isnot case sensitive operator with Float values`() {
    assertCommandOutput("echo 1.0 isnot# 1.0", "0")
    assertCommandOutput("echo 1.0 isnot# 2.0", "1")
  }

  @Test
  fun `test isnot case sensitive operator does not coerce Number and Float`() {
    assertCommandOutput("echo 1 isnot# 1.0", "1")
  }

  @Test
  fun `test isnot case sensitive operator with String`() {
  ...
  @Test
  fun `test isnot case sensitive operator does not coerce String and Number`() {
    assertCommandOutput("echo '1' isnot# 1", "1")
  }

  @Test
  fun `test isnot case sensitive operator compares Lisnott references`() {
  ...
  @Test
  fun `test isnot case sensitive operator compares Dictionary references`() {
    assertCommandOutput("echo {} isnot# {}", "1")
  ...
  @Test
  fun `test isnot case sensitive operator treats different Funcref function references without arguments or dictionary as same`() {
  ...
  @Test
  fun `test isnot case sensitive operator treats different Funcref funcref references as different`() {
  ...
  @Test
  fun `test isnot case sensitive operator treats Funcref references with different arguments as different`() {
  ...
  @Test
  fun `test isnot case sensitive operator treats Funcref references with different dictionary as different`() {
