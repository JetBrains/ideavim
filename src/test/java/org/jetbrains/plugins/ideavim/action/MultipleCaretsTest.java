...
public class MultipleCaretsTest extends VimTestCase {
  ...
  public void testMotionLeftAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("3h"), "abc<caret>de<caret>");
    assertState("<caret>ab<caret>cde");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionRightAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("l"), "ab<caret>cd<caret>ef");
    assertState("abc<caret>de<caret>f");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMovementMerging() {
    Editor editor = typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2h"), "o<caret>n<caret>e");
  ...
  public void testMotionColumnAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("4|"), "one<caret> two\n" +
  ...
  public void testMotionFirstColumnAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("0"), "one<caret> two\n" +
                                   "three four fiv<caret>e\n" +
                                   "si<caret>x seven<caret>\n" +
  ...
  public void testMotionFirstNonSpaceAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("^"),
                   "     one<caret> two\n" + "three<caret> four\n" + "  five<caret> six\n" + " <caret>  seven eight");
    assertState("     <caret>one two\n" + "<caret>three four\n" + "  <caret>five six\n" + "   <caret>seven eight");
  }
  ...
  public void testMotionLastNonSpaceAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("g_"), "one<caret> two   \n" +
                                    "three<caret> four      \n" +
                                    " five si<caret>x\n" +
                                    "seven eight    <caret>  \n");
    assertState(
  ...
  public void testMotionLastColumnAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("$"), "one <caret>two\n" + "three fou<caret>r");
    assertState("one tw<caret>o\n" + "three fou<caret>r");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionLeftMatchCharAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2Fa"), "a<caret>a<caret>abab<caret>ab<caret>ab<caret>b<caret>x");
    assertState("<caret>a<caret>a<caret>ab<caret>ab<caret>ababbx");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionRightMatchCharAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2fb"), "a<caret>a<caret>abab<caret>ab<caret>ab<caret>b<caret>x");
    assertState("aaaba<caret>baba<caret>b<caret>b<caret>x");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionLeftTillMatchCharAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2Ta"), "b<caret>a<caret>ba<caret>a<caret>a<caret>ba<caret>b");
    assertState("b<caret>a<caret>ba<caret>a<caret>a<caret>bab");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionRightTillMatchCharAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2ta"), "<caret>b<caret>a<caret>b<caret>a<caret>a<caret>a<caret>ba<caret>b");
    assertState("ba<caret>b<caret>a<caret>a<caret>a<caret>ba<caret>b");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionLastLeftMatchChar() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("Fa;"), "a<caret>a<caret>abab<caret>ab<caret>ab<caret>b<caret>x");
    assertState("<caret>aa<caret>ab<caret>ab<caret>ababbx");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionLastRightMatchChar() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("fb;"), "<caret>a<caret>aabab<caret>ab<caret>ab<caret>b<caret>x");
    assertState("aaaba<caret>baba<caret>b<caret>b<caret>x");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionLastRightTillMatchChar() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("ta;"), "<caret>b<caret>a<caret>b<caret>a<caret>a<caret>a<caret>ba<caret>b");
    assertState("ba<caret>b<caret>a<caret>aa<caret>ba<caret>b");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionLastMatchCharReverse() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("fa" + "2;" + "3,"), "abaab<caret>a<caret>baaa<caret>abaaba");
    assertState("abaab<caret>abaaa<caret>abaaba");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionLeftWrap() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("5<BS>"), "one\n" + "t<caret>wo three\n" + "fo<caret>ur\n");
    assertState("<caret>one\ntwo thr<caret>ee\nfour\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionRightWrap() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("5<Space>"), "<caret>one\n" + "two thr<caret>ee\n" + "four\n");
    assertState("one\nt<caret>wo three\nfo<caret>ur\n");
  }
  ...
  public void testMotionUpAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("k"), "o<caret>ne\n" + "t<caret>wo<caret> \n" + "t<caret>hree<caret> ");
    assertState("o<caret>n<caret>e\n" + "t<caret>wo<caret> \n" + "three ");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionDownAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2j"),
  ...
  public void testLeftRightAndUpDownMovements() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("khj"), "abcde\n" + "ab<caret>cde\n" + "abc<caret>de\n" + "abcd<caret>e\n");
    assertState("abcde\n" + "a<caret>bcde\n" + "ab<caret>cde\n" + "abc<caret>de\n");
  }
  ...
  public void testMotionDownLess1FirstNonSpaceActionWithNoCount() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("_"),
                   "     one<caret> two\n" + "three<caret> four\n" + "  five<caret> six\n" + " <caret>  seven eight");
    assertState("     <caret>one two\n" + "<caret>three four\n" + "  <caret>five six\n" + "   <caret>seven eight");
  }
  ...
  public void testMotionDownLess1FirstNonSpaceActionWithCount() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("3_"), "x<caret>y<caret>z\n" +
  ...
  public void testMotionUpFirstNonSpaceAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("-"), " one\n" + "<caret>  tw<caret>o\n");
    assertState(" <caret>one\n" + "  two\n");
  }
  ...
  public void testMotionInnerBigWordAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "iW"), "a,<caret>bc<caret>d,e f,g<caret>hi,j");
  ...
  public void testMotionInnerBlockAngleAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "2i<"), "<asdf<asdf<a<caret>sdf>a<caret>sdf>asdf> <asdf<as<caret>df>asdf>");
  ...
  public void testMotionInnerBlockBackQuoteActionWithNoCount() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "i`"), "`as<caret>d<caret>f`asdf `a<caret>sdf`a<caret>sdf`a<caret>sdf`");
    assertState(
  ...
  public void testMotionInnerBlockTagAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "it"),
  ...
  public void testMotionInnerParagraphAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "3ip"),
                   "a<caret>bcd\na<caret>bcd\n\nabcd\nabcd\n\na<caret>bcd\nabcd\n\nabcd\nabcd\n");
  ...
  public void testMotionInnerSentenceAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "3is"), "a<caret>bcd a<caret>bcd. abcd abcd. a<caret>bcd abcd.");
  ...
  public void testMotionOuterBigWordAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "aW"), " a<caret>bcd<caret>e.abcde.a<caret>bcde  a<caret>bcde.abcde\n");
  ...
  public void testMotionOuterBlockAngleAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "2a<"), "<asdf<asdf<a<caret>sdf>a<caret>sdf>asdf> <asdf<a<caret>sdf>asdf>");
    assertState("<selection><asdf<asdf<asdf>asdf>asdf></selection> <selection><asdf<asdf>asdf></selection>");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionOuterBlockBackQuoteAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "a`"), "`asdf`asdf`a<caret>sdf`a<caret>sdf`asdf` `asdf`a<caret>sdf`asdf`");
  ...
  public void testMotionOuterBlockTagAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "at"),
                   "<asdf1>qwer<asdf2>qwer<asdf3>qw<caret>er</asdf3>qw<caret>er</asdf2>qwer</asdf1>\n" +
                   "<asdf1>qwer<asdf2>qw<caret>er</asdf2>qwer</asdf1>");
  ...
  public void testMotionOuterParagraphAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "2ap"), "a<caret>sdf\n\na<caret>sdf\n\nasdf\n\n");
    assertState("<selection>asdf\n\nasdf\n\nasdf\n\n</selection>");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionOuterSentenceAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "2as"), "a<caret>sdf. a<caret>sdf. asdf.");
  ...
  public void testMotionBigWordEndLeftAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("gE"), "a.asdf. a<caret>sdf<caret>.a a; as<caret>df\n a<caret>sdf");
    assertState("a.asdf<caret>. asdf.a a<caret>; asd<caret>f\n asdf");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionBigWordEndRightAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("E"), "a<caret>.as<caret>df. a<caret>s<caret>df.a <caret> a; as<caret>df");
    assertState("a.asdf<caret>. asdf.<caret>a  a<caret>; asd<caret>f");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionBigWordLeftAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("B"), "a<caret>.as<caret>df. a<caret>sdf.a <caret> a; as<caret>df");
    assertState("<caret>a.asdf. <caret>asdf.a  a; <caret>asdf");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionBigWordRightAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("W"), "a<caret>.as<caret>df. a<caret>sdf.a <caret> a; as<caret>df");
  ...
  public void testMotionCamelEndLeftAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2]b"),
  ...
  public void testMotionCamelEndRightAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("]w"),
  ...
  public void testMotionMethodNextEndAction() {
    configureByJavaText("public class Foo {\n" +
                        ...
                        "    }\n" +
                        "}");
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("]M"));
  ...
  public void testMotionNthCharacterAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("5" + "go"),
  ...
  public void testMotionParagraphNextAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2}"), "o<caret>ne\n\n<caret>two\n\nthree\nthree\n\nfour\n\nfive");
    assertState("one\n\ntwo\n<caret>\nthree\nthree\n<caret>\nfour\n\nfive");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionParagraphPreviousAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2{"), "one\n\ntwo\n\nthree\nthree\n\nfou<caret>r\n\nfi<caret>ve");
    assertState("one\n\ntwo\n<caret>\nthree\nthree\n<caret>\nfour\n\nfive");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionSectionBackwardEndAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("[]"), "no<caret>t_a_brace\n" +
                                    "{\n" +
                                    "<caret>not_a_brace\n" +
                                    "}\n" +
                                    "{\n" +
  ...
  public void testMotionSectionBackwardStartAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("[["), "n<caret>ot_a_brace\n" +
                                    "{\n" +
                                    "not_a_<caret>brace\n" +
                                    "<caret>}\n" +
                                    "{\n" +
  ...
  public void testMotionSentenceNextEndAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("g)"), "a<caret>sdf<caret>. a<caret>sdf. a<caret>sdf.<caret> asdf.<caret> asdf.");
    assertState("asdf<caret>. asdf<caret>. asdf<caret>. asdf<caret>. asdf<caret>.");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionSentenceNextStartAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys(")"), "a<caret>sdf. <caret>asdf.<caret> asdf. <caret>asdf. asdf.");
    assertState("asdf. <caret>asdf. <caret>asdf. asdf. <caret>asdf.");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionSentencePreviousEndAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("g("), "asdf.<caret> a<caret>sdf<caret>. as<caret>df. asd<caret>f. <caret>asdf.");
    assertState("asdf<caret>. asdf<caret>. asdf<caret>. asdf<caret>. asdf.");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionSentencePreviousStartAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("("), "asd<caret>f. <caret>as<caret>df. asdf<caret>. asdf<caret>. as<caret>df.");
    assertState("<caret>asdf. <caret>asdf. <caret>asdf. <caret>asdf. <caret>asdf.");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMotionUnmatchedBraceCloseAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("]}"), "{{}<caret> }<caret> }<caret> {}}<caret>{}}");
  ...
  public void testVisualSwapEndsAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "iw" + "o"), "o<caret>ne <caret>two th<caret>ree\n");
    assertState(
  ...
  public void testVisualToggleCharacterMode() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "e"), "o<caret>ne <caret>two th<caret>ree");
  ...
  public void testVisualToggleLineMode() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("V" + "2k"), "one two\n" +
                                         "three four\n" +
                                         "fi<caret>ve six\n" +
                                         "seven eight\n" +
                                         "nine ten\n" +
  ...
  public void testVisualModeMerging() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("V" + "j"), "one<caret> two\n" + "thr<caret>ee four\n" + "five six\n");
    assertState("<selection>one two\n" + "three four\n" + "five six\n</selection>");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testVisualCharacterToVisualLineModeSwitch() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "k" + "V"),
                   "one two\n" + "three fo<caret>ur\n" + "five six\n" + "seven eight\n" + "nine t<caret>en\n");
    assertState("<selection>one two\n" +
                "three four\n" +
                "</selection>five six\n" +
  ...
  public void testVisualBlockDownAfterLineEndMovement() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<C-V>$j"), "abc\ndef\n");
    assertState("<selection>abc</selection>\n" + "<selection>def</selection>\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testVisualBlockDownMovementAfterShorterLineAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<C-V>" + "kkjj"), "one\n" + "\n" + "two three\n" + "four fi<caret>ve\n");
    assertState("one\n" + "\n" + "two three\n" + "four fi<selection><caret>v</selection>e\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testVisualBlockDownMovementWithEmptyLineInMiddle() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<C-V>" + "3k" + "j"), "one\n" + "\n" + "two three\n" + "four fi<caret>ve\n");
  ...
  public void testVisualBlockDownMovementWithManyEmptyLinesInMiddle() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<C-V>" + "4kjjj"), "one\n" + "\n" + "\n" + "two three\n" + "four fi<caret>ve\n");
    assertState("one\n" + "\n" + "\n" + "two thr<selection>e</selection>e\n" + "four fi<selection>v</selection>e\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testMergingSelections() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "aW" + "l" + "h"), "a<caret>bcde.abcde.abcde  ab<caret>cde.abcde\n");
  ...
  public void testVisualMotionUp() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "k" + "k"), "abcde\nabcde\nab<caret>cde\n");
    assertState("ab<selection>cde\nabcde\nabc</selection>de\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testVisualMotionDown() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "2j" + "j"), "ab<caret>cde\nabcde\n\nabcde\n");
    assertState("ab<selection>cde\nabcde\n\nabc</selection>de\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testVisualLineMotionUp() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("V" + "2k" + "k"), "abcde\nabcde\n\nab<caret>cde\nabcde\n");
  ...
  public void testVisualCharacterDownMerging() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "2j" + "j"), "abc<caret>de\nab<caret>cde\n\nabcde\nabcde\n");
  ...
  public void testAutoIndentLinesVisualAction() {
    configureByJavaText("<caret>public class Foo {\n" +
                        ...
                        "}\n" +
                        "}\n");
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("V2j="));
  ...
  public void testChangeCaseLowerMotionAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("gu2w"), "O<caret>NcE thIs <caret>TEXt wIlL n<caret>Ot lOoK s<caret>O rIdIcuLoUs\n");
  ...
  public void testChangeCaseLowerVisualAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v2wu"), "O<caret>NcE thIs <caret>TEXt wIlL n<caret>Ot lOoK s<caret>O rIdIcuLoUs\n");
  ...
  public void testChangeCaseToggleCharacterAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("5~"), "OnE t<caret>Wo <caret>ThReE<caret> fOuR fIvE\n");
    assertState("OnE twO Th<caret>rEe<caret> FoUr<caret> fIvE\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testChangeCaseToggleMotionAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("g~e"), "<caret>capitalize <caret>UNCAPITALIZE<caret> <caret>sTaY\n");
    assertState("<caret>CAPITALIZE <caret>uncapitalize<caret> <caret>sTaY\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testChangeCaseToggleVisualAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("ve~"), "<caret>capitalize <caret>UNCAPITALIZE\n");
    assertState("<caret>CAPITALIZE <caret>uncapitalize\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testChangeCaseUpperMotionAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("gU2w"), "O<caret>NcE thIs <caret>TEXt wIlL <caret>nOt lOoK <caret>sO rIdIcuLoUs\n");
  ...
  public void testChangeCharacterAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("rz"), "on<caret>e <caret>t<caret>w<caret>o th<caret>r<caret>ee");
    assertState("on<caret>z <caret>z<caret>z<caret>z th<caret>z<caret>ze");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testChangeCharacterActionWithCount() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2rz"), "on<caret>e <caret>t<caret>w<caret>o th<caret>r<caret>ee");
    assertState("on<caret>zz<caret>z<caret>z<caret>zzth<caret>z<caret>zz");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testChangeCharactersAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("4s" + "<ESC>"), "on<caret>e two <caret>th<caret>ee four five\n");
    assertState("o<caret>no<caret> r five\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testChangeEndOfLineAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("Cabc" + "<ESC>"),
                   "a<caret>bcde\n" + "abcde\n" + "a<caret>bcde\n" + "a<caret>bcd<caret>e\n" + "abcde\n");
  ...
  public void testChangeLineAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("c2ca" + "<ESC>"), "ab<caret>cde\n" + "abcde\n" + "abcde\n" + "abc<caret>de\n" + "abcde\n");
    assertState("<caret>a\n" + "abcde\n" + "<caret>a\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testOneCaretPositionAfterChangeLineAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("c2c" + "<ESC>"), "abcde\n" + "ab<caret>cde\n" + "abcde\n" + "abcde\n");
    assertState("abcde\n" + "<caret>\n" + "abcde\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testCaretPositionAfterChangeLineAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("c2c" + "<ESC>"), "abcd<caret>e\n" +
                                              "abcde\n" +
                                              "abcde\n" +
                                              "ab<caret>cde\n" +
                                              "abcde\n" +
  ...
  public void testChangeMotionAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("ciw" + "correct" + "<ESC>"), "correct correct wron<caret>g wr<caret>ong correct\n");
  ...
  public void testChangeNumberIncAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<C-A>"), "1<caret>7<caret>7 2<caret>38 <caret>999\n");
    assertState("17<caret>9 23<caret>9 100<caret>0\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testChangeNumberDecAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<C-X>"), "1<caret>8<caret>1 2<caret>40 <caret>1001\n");
    assertState("17<caret>9 23<caret>9 100<caret>0\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testChangeReplaceAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("Rz" + "<ESC>"), "on<caret>e <caret>t<caret>w<caret>o th<caret>r<caret>ee");
    assertState("on<caret>z <caret>z<caret>z<caret>z th<caret>z<caret>ze");
  }
  ...
  public void testChangeReplaceActionWithSeveralCharacters() {
    ...
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("Rrty" + "<Esc>"), before);
  ...
  public void testChangeVisualCharacterAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v2lra"), "abcd<caret>ffffff<caret>abcde<caret>aaaa\n");
    assertState("abcdaa<caret>afffaa<caret>adeaa<caret>aa\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testChangeVisualLinesAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("VjS" + "abcde" + "<ESC>"),
                   "gh<caret>ijk\n" + "ghijk\n" + "abcde\n" + "ghi<caret>jk\n" + "ghijk\n");
  ...
  public void testChangeVisualLinesEndAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("vjC" + "abcde" + "<ESC>"),
                   "gh<caret>ijk\n" + "ghijk\n" + "abcde\n" + "ghi<caret>jk\n" + "ghijk\n");
    assertState("abcd<caret>e\n" + "abcde\n" + "abcd<caret>e\n");
  }
  ...
  public void testDeleteCharacterAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<Del>"), "a<caret>bcde\n" + "<caret>abcde\n" + "abcd<caret>e\n");
    assertState("a<caret>cde\n" + "<caret>bcde\n" + "abc<caret>d\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testDeleteCharacterActionOrder() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<Del>"), "ab<caret>c<caret>d<caret>e abcde\n");
    assertState("ab<caret> abcde\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testDeleteCharacterLeftAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("3X"), "a<caret>bcde\n" + "<caret>abcde\n" + "abcd<caret>e\n");
    assertState("<caret>bcde\n" + "<caret>abcde\n" + "a<caret>e\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testDeleteCharacterLeftCaretMerging() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("3X"), "a<caret>bc<caret>def<caret>ghij<caret>klmn<caret>op<caret>q");
    assertState("gq");
  }
  ...
  public void testDeleteCharacterRightCaretMerging() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("4x"), "o<caret>ne <caret>two <caret>three four");
    assertState("o<caret> four");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testDeleteEndOfLineAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("D"), "abcd<caret>e\n" +
                                   "abcde\n" +
                                   "abc<caret>de\n" +
                                   "<caret>abcde\n" +
                                   "ab<caret>cde\n" +
  ...
  public void testDeleteEndOfLineActionWithCount() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("3D"), "ab<caret>cde\n" +
                                    "abcde\n" +
                                    "abcde\n" +
                                    "abcd<caret>e\n" +
                                    "a<caret>bcd<caret>e\n" +
  ...
  public void testDeleteJoinLinesAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("gJ"), "ab<caret>cde\n" +
                                    "abcde\n" +
                                    "ab<caret>cde\n" +
                                    "abcd<caret>e\n" +
                                    "abcde\n" +
  ...
  public void testDeleteJoinLinesSimpleAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("gJ"), "a<caret>bcde\n" + "abcde\n");
    assertState("abcde<caret>abcde\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testDeleteJoinLinesSpacesAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("J"), "ab<caret>cde\n" +
                                   "abcde\n" +
                                   "ab<caret>cde\n" +
                                   "abcd<caret>e\n" +
                                   "abcde\n" +
  ...
  public void testDeleteJoinVisualLinesAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("VkgJ"), "one\n" + "tw<caret>o\n" + "three\n" + "fo<caret>ur\n");
    assertState("one<caret>two\n" + "three<caret>four\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testDeleteJoinVisualLinesSpacesAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("VkJ"), "abcde\n" + "abcd<caret>e\n" + "abcde\n" + "ab<caret>cde\n");
    assertState("abcde<caret> abcde\n" + "abcde<caret> abcde\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testDeleteVisualAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("vlj"), "abc<caret>de\n" + "<caret>abcde\n" + "abc<caret>de\n" + "abcde\n");
    assertState(
      "abc<selection>de\n" + "abcde\n" + "a<caret>b</selection>c<selection>de\n" + "abcd<caret>e</selection>\n");
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("d"));
    assertState("abc<caret>c\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testDeleteVisualActionWithMultipleCaretsLeft() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("v" + "fd" + "d"), "a<caret>bcde\n" + "abcde\n" + "<caret>abcde\n" + "ab<caret>cde\n");
    assertState("a<caret>e\n" + "abcde\n" + "<caret>e\n" + "ab<caret>e\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testDeleteVisualLinesAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("Vjd"), "abc<caret>de\n" + "abcde\n" + "abcde\n" + "a<caret>bcde\n" + "abcde\n");
  ...
  public void testInsertEscape() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("i" + "<ESC>" + "i" + "<ESC>"), "on<caret>e tw<caret>o th<caret>ree");
    assertState("<caret>one <caret>two <caret>three");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testInsertAfterCursorActionMovement() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("a" + "<ESC>"), "on<caret>e two th<caret>ree");
    assertState("on<caret>e two th<caret>ree");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testInsertAfterCursorAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("a" + "abcd" + "<ESC>"), "on<caret>e two th<caret>re<caret>e");
    assertState("oneabc<caret>d two thrabc<caret>deeabc<caret>d");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testInsertBeforeCursorAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("i" + "four" + "<ESC>"), "one two three <caret> \n" + "seven six five <caret> \n");
    assertState("one two three fou<caret>r \n" + "seven six five fou<caret>r \n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testInsertBeforeFirstNonBlankAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("I" + "four " + "<ESC>"),
  ...
  public void testInsertCharacterAboveCursorAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("a" + "<C-Y>" + "<C-Y>" + "<C-Y>" + "<ESC>"), " one two three four\n" +
  ...
  public void testInsertCharacterBelowCursorAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("a" + "<C-E>" + "<C-E>" + "<C-E>" + "<ESC>"), "<caret>  two three four\n" +
                                                                       " one two three four\n" +
                                                                       "four three two<caret> \n" +
                                                                       "four three two one\n");
  ...
  public void testInsertDeleteInsertedTextAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("a" + "asdf" + "<C-U>" + "<ESC>"), "on<caret>e two th<caret>ree");
    assertState("on<caret>e two th<caret>ree");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testInsertEnterAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("i" + "<C-M>" + "<ESC>"), "one<caret>two<caret>three<caret>four\n");
    assertState("one\n" + "<caret>two\n" + "<caret>three\n" + "<caret>four\n");
  }

  @TestWithoutNeovim(reason = SkipNeovimReason.MULTICARET)
  public void testInsertLineStartAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("gI" + "four " + "<ESC>"),
                   "  three t<caret>wo on<caret>e\n" + "<caret> five six se<caret>ven eight\n");
    assertState("four<caret>   three two one\n" + "four<caret>  five six seven eight\n");
  }
  ...
  public void testInsertNewLineAboveAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("O" + "abcde" + "<ESC>"),
                   "ab<caret>cde\n" + "ab<caret>cde\n" + "abcde\n" + "abc<caret>de\n");
    assertState("abcd<caret>e\n" + "abcde\n" + "abcd<caret>e\n" + "abcde\n" + "abcde\n" + "abcd<caret>e\n" + "abcde\n");
  }
  ...
  public void testInsertNewLineAboveActionWithMultipleCaretsInLine() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("O" + "<ESC>"), "a<caret>bcd<caret>e\n" + "abc<caret>d<caret>e\n");
  ...
  public void testInsertSingleCommandAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("i" + "<C-O>" + "2h" + "<ESC>"), "one <caret>two <caret>three <caret>four\n");
  ...
  public void testShiftLeftLinesAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2<<"),
                   "        <caret>abcde\n" + "        abcde\n" + "    abcde\n" + "    <caret>abcde\n" + "    abcde\n");
    assertState("    <caret>abcde\n" + "    abcde\n" + "    abcde\n" + "<caret>abcde\n" + "abcde\n");
  }
  ...
  public void testShiftLeftMotionAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<j"),
                   "        <caret>abcde\n" + "        abcde\n" + "    abcde\n" + "    <caret>abcde\n" + "    abcde\n");
    assertState("    <caret>abcde\n" + "    abcde\n" + "    abcde\n" + "<caret>abcde\n" + "abcde\n");
  }
  ...
  public void testShiftLeftVisualAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("Vj<"),
                   "        <caret>abcde\n" + "        abcde\n" + "    abcde\n" + "    <caret>abcde\n" + "    abcde\n");
    assertState("    <caret>abcde\n" + "    abcde\n" + "    abcde\n" + "<caret>abcde\n" + "abcde\n");
  }
  ...
  public void testMotionGoToLineFirst() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("i" + "<C-Home>"), "    sdf" +
  ...
  public void testMotionGotoLineLastEnd() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("<C-End>"), "    sdfdsfa<caret>dsf fg dsfg sd<caret>fjgkfdgl jsdf\n" +
                                         "nflgj sd\n" +
                                         " dflgj dfdsfg\n" +
  ...
  public void testMotionGotoLineLastEndInsertMode() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("i" + "<C-End>"), "    sdfdsfa<caret>dsf fg dsfg sd<caret>fjgkfdgl jsdf\n" +
                                              "nflgj sd\n" +
                                              " dflgj dfdsfg\n" +
                                              " hdfsgj sdf<caret>klgj\n");
    assertState(
  ...
  public void testSearchWholeWordForwardAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2*"), "q<caret>we as<caret>d zxc qwe asd zxc qwe asd zxc qwe asd zxc qwe asd zxc ");
  ...
  public void testSearchWholeWordBackwardAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("2#"), "qwe asd zxc qwe asd zxc <caret>qwe <caret>asd zxc qwe asd zxc qwe asd zxc ");
  ...
  public void testMotionGotoLineLastAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("G"), "dfgdfsg<caret>gfdfgdfs dasgdfsk dfghsdfkj gh\n" +
  ...
  public void testMotionGotoLineLastWithArgumentAction() {
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("1G"), "dfgdfsg<caret>gfdfgdfs dasgdfsk dfghsdfkj gh\n" +
                                    "lsdjf lsj<caret> flk gjdlsadlsfj <caret>lksdgfj \n" +
                                    "dflgjdfsgk<caret>d<caret>flgjdfsklg\n\n");
  ...
  public void testInsertAtPreviousInsert() {
    ...
    typeTextInFile(VimInjectorKt.getInjector().getParser().parseKeys("I" + "rty" + "<Esc>" + "2lj" + "gi" + "fgh" + "<Esc>"), before);
  ...
  public void testAutoIndentMotion() {
    final String before = "cl<caret>ass C {\n C(int i) {\nmy<caret>I = i;\n}\n private int myI;\n}";
    configureByJavaText(before);
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("=3j"));
  ...
  public void testPutTextBeforeCursor() {
    ...
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("P" + "3l" + "P"));
  ...
  public void testPutTextBeforeCursorOverlapRange() {
    ...
    final Editor editor = configureByText(before);
    VimPlugin.getRegister().storeText(new IjVimEditor(editor), new TextRange(16, 19), SelectionType.CHARACTER_WISE, false);
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("P"));
  ...
  public void testPutTextAfterCursor() {
    ...
    final Editor editor = configureByText(before);
    VimPlugin.getRegister().storeText(new IjVimEditor(editor), new TextRange(16, 19), SelectionType.CHARACTER_WISE, false);
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("p" + "3l" + "2p"));
  ...
  public void testPutTextAfterCursorOverlapRange() {
    ...
    final Editor editor = configureByText(before);
    VimPlugin.getRegister().storeText(new IjVimEditor(editor), new TextRange(16, 19), SelectionType.CHARACTER_WISE, false);
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("2p"));
  ...
  private void testPutOverlapLine(@NotNull String before, @NotNull String after, boolean beforeCursor) {
    ...
    VimPlugin.getRegister().storeText(new IjVimEditor(editor), new TextRange(14, 21), SelectionType.LINE_WISE, false);
    typeText(VimInjectorKt.getInjector().getParser().parseKeys(beforeCursor ? "P" : "p"));
    assertState(after);
  }
  ...
  public void testPutTextBeforeCursorMoveCursor() {
    ...
    final Editor editor = configureByText(before);
    VimPlugin.getRegister().storeText(new IjVimEditor(editor), new TextRange(16, 19), SelectionType.CHARACTER_WISE, false);
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("l" + "gP" + "b" + "gP"));
  ...
  public void testPutTextBeforeCursorMoveCursorLinewise() {
    ...
    final Editor editor = configureByText(before);
    VimPlugin.getRegister().storeText(new IjVimEditor(editor), new TextRange(14, 21), SelectionType.LINE_WISE, false);
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("gP"));
    final String after =
      "zxcvbn\n" + "<caret>qwerty\n" + "zxcvbn\n" + "<caret>asdfgh\n" + "zxcvbn\n" + "<caret>zxcvbn\n";
    assertState(after);
  }
  ...
  public void testYankMotion() {
    ...
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("ye"));
  ...
  public void testYankMotionLineWise() {
    final String before = "<caret>qwe\n" + "rty\n" + "asd\n" + "<caret>fgh\n" + "zxc\n" + "vbn\n";
    configureByText(before);
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("yj"));
  ...
  public void testYankLine() {
    final String before = "<caret>qwe\n" + "asd\n" + "zxc\n" + "<caret>rty\n" + "fgh\n" + "vbn\n";
    configureByText(before);
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("2yy"));
    ...
    typeText(VimInjectorKt.getInjector().getParser().parseKeys("j" + "p"));
    final String after = "qwe\n" +
                         "asd\n" +
                         "<caret>qwe\n" +
                         "asd\n" +
